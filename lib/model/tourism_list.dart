...
class _TourismListState extends State<TourismList> {
  ...
  final List<TourismPlace> tourismPlaceList = [
    TourismPlace(
        ...
        location:
            'Jl. Badrawati, Kec. Borobudur, Kabupaten Magelang, Jawa Tengah',
    ...
    TourismPlace(
        ...
        deskrisi:
            'Pasar Sore Malioboro merupakan pasar yang menjual oleh-oleh khas Jogja. Pasar tersebut menyediakan berbagai kebutuhan wisatawan dengan harga yang murah.',
        waktu: '17:00 - 21:00',
        hari: 'Open Everyday',
        tiket: 'Free',
        galeri: [
    ...
    TourismPlace(
        name: 'Tugu Pahlawan',
        location:
            'Jl. Pahlawan, Alun-alun Contong, Kec. Bubutan, Kota SBY, Jawa Timur',
